function talk() {
  var know = {
    ...
    "i wish i had a talent like that.":
      "i'm sure you have a talent. it's just hidden.",
    ...
    "if only i was talented.":
      "you have a talent. you just don't know what it is yet.",
    ...
    "so what was the score?": "the score was1-.",

    "the score was1-.": "man, that was a really close game.",
    ...
    "what was the score at the end of the game?": "our team won1-.",

    "our team won1-.": "sounds like it was a close game.",
    ...
    "so tell me the final score.": "the other team lost by three points,-.",

    "the other team lost by three points,-.": "it must've been a close game.",
    ...
    "no, i had no idea.": "well, she did, her baby was  pounds  ounces.",

    "well, she did, her baby was  pounds  ounces.": "oh my god, that's great!",
    ...
    "i honestly didn't know.": "the baby was  pounds  ounces.",

    "the baby was  pounds  ounces.": "that's good to hear.",
    ...
    "i really wasn't told anything.": "she was a cute  pounds  ounces.",

    "she was a cute  pounds  ounces.": "wow, how exciting.",
    ...
    "did you make it to school today?":
      "i always do. did you go to school today?",
    ...
    "i don't want to see a movie by myself.":
      "okay, so are you going to school tomorrow?",
    ...
    "i've just been working a lot.":
      "whatever the reason may be, i'm glad you visited me.",
    ...
    "i'm not sure, but i don't think she's given out that many.":
      "well, hopefully she'll give me my invite later on today.",
    ...
    "i really don't know, but i don't think she gave out that many yet.":
      "i really want to go, so i hope that she gives me my invite soon.",
    ...
    "when exactly does the party start?":
      "the invitation says it starts at  p.m.",

    "the invitation says it starts at  p.m.":
      "has she given out a lot of invitations yet?",

    "has she given out a lot of invitations yet?":
      "i have no idea, she hasn't given out many though.",
    ...
    "when does it start?": "at  p.m.",

    "at  p.m.": "i'll be there.",
    ...
    "the party starts at .": "yeah, i think i'll go.",
